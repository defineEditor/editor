...
class ConnectedCodeListsTable extends React.Component {
    constructor(props) {
        super(props);
...
ConnectedCodeListsTable.propTypes = {
...
const CodeListsTable = connect(mapStateToProps, mapDispatchToProps)(ConnectedCodeListsTable);
