...
class AddDefineFormStep2 extends React.Component {
    ...
    handleChange = name => event => {
        if (name === 'defineVersion' && !this.props.standardNames[event.target.value].includes[this.state.standard]) {
            this.setState({
    ...
    handleNext = event => {
        ...
        let defineData = getEmptyDefineXml({
            studyName     : this.props.study.name,
                    ...
                    <Grid container spacing={16} className={classes.root}>
                        <Grid item xs={12}>
                            <TextField
                                ...
                                select
                            >
                                {getSelectionList(this.props.standardNames[this.state.defineVersion])}
                            </TextField>
                            <Grid item xs={12}>
                            </Grid>
                            <TextField
